...
TextDecoderStream('verify result array', () => {
    const resultArray = Object.keys(normalizedData.entities.notifications);
    expect(resultArray).toEqual(expect.arrayContaining([
...
test('verify message entity', () => {
    const messageEntity = normalizedData.entities.messages['efb6c485-00f7-4fdf-97cc-5e12d14d6c41'];
...
test('verify notification entity', () => {
